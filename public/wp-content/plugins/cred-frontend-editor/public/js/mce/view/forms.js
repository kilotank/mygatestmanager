		...
		editor.on( 'wptoolbar', function( event ) {
			...
			if ( linkNode ) {
				...
				if ( _.contains( nodeClass, self.CONST.previewClass ) ) {
					...
					switch( tag ) {
						case 'cred_form':
							id = ( _.has( Toolset.Forms.dataCache.forms.post, slug ) ) ? Toolset.Forms.dataCache.forms.post[ slug ].id : id;
							href += '&post=' + id;
							break;
						case 'cred_user_form':
							id = ( _.has( Toolset.Forms.dataCache.forms.user, slug ) ) ? Toolset.Forms.dataCache.forms.user[ slug ].id : id;
							href += '&post=' + id;
							break;
						case 'cred-relationship-form':
							id = ( _.has( Toolset.Forms.dataCache.forms.relationship, slug ) ) ? Toolset.Forms.dataCache.forms.relationship[ slug ].id : id;
